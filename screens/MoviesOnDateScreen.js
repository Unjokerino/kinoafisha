  ...
  async function getData(){
    ...
    result.forEach(movie => {
        movie.seanses.forEach(seans =>{
            if(moment(seans.date).format("MM/DD") === moment(props.route.params.date).format("MM/DD")){
                seanses.push({
                    ...movie,
                    seanses:[seans]
                })
  ...
  return (
    <View style={styles.container}>
      ...
      <Appbar
        ...
        >
        <Appbar.Action onPress={() => props.navigation.goBack()} icon="arrow-left" />
        <Appbar.Content title={"Сеансы на " +moment(props.route.params.date).format("D MMMM")} />
        </Appbar>
        <View style={styles.scheduleContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => <MovieCard detailType="DetailMovieScreen" url={props.route.params.url} darkTheme={darkTheme} navigation={props.navigation} {...item}></MovieCard>}
